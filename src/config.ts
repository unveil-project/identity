export const CONFIG = {
	...
	BOUNTY_REPO_MERGE_RATE_CLEAN: 0.5, // >= 50% of closed bounty PRs merged = skip amplification (legitimate contributor)
	...
	BOUNTY_AMPLIFIER_HIGH: 1.3, // >= 75% bounty PR ratio — amplifies existing automation signals
	BOUNTY_AMPLIFIER_LOW: 1.15, // >= 40% bounty PR ratio or labeling activity — mild amplifier
